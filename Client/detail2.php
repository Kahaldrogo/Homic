        ...
        <div id="acceuil">
               ...
               <div class="container-fluid">
                   ...
                   <div class="row" style="border-bottom:1px solid black">
                       ...
                       <div class="col-md-4">
                            <h2>prix de la realisation: <span  style="color:goldenrod;"> 40000fr</span></h2>
                   ...
                   <div class="row">
                        <div class="col-md-8">
                            <h2>Description</h2>
                            <p>La toillette a double fosse est une latrine ventilee et amelioree a chasse manuelle utilisant peu d'eau. <br>Elle ne requiert pas de vidange mecaniques couteuses, facile a construire  avec un pot de defecation resistant muni d'un mecanisme de fermeture automatique. Elle est sans odeur ni insectes avec une vidange facile et tres durable.</p>
                        </div>
                        <div class="col-md-4">
                             <h3>Details projet</h3>
                             <p>Elle est connectee a deux fosses a usage alterne. lorsqu'une fosse es pleine la toillette est connecte a lautre fossse. la toilette pleine est vidange manuellement de facon hygeniqueet sans danger apre un an. <br>Elle est dote d'un tuyau de ventilation et d'aeration.</p>
